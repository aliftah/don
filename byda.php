...
<form method="POST">
service Source<input type="date" name="da"> <br>
...
$query = "SELECT serv_id,id,serv_src,serv_dest,serv_status,serv_date,serv_time FROM service WHERE serv_date LIKE '%$da%'";			
